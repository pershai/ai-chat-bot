...
class ConversationControllerTest {
    ...
    void getConversation_ExistingId_ReturnsConversation() throws Exception {
        ...
        when(conversationService.getConversation(100)).thenReturn(Optional.of(conversation));
    ...
    void getConversation_NonExistingId_ReturnsNotFound() throws Exception {
        // Arrange
        when(conversationService.getConversation(999)).thenReturn(Optional.empty());
...
//        msg2.setTimestamp(LocalDateTime.now());
        ...
        when(conversationService.getConversationMessages(100)).thenReturn(messages);
